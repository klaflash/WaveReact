...
function LocationPage(props) {
  ...
  console.log(inRange, locationName);
      ...
      <div id='location-card-1'>
        <div id='location-header'>
          <button className='back-button' onClick={goBack}>
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"/></svg>
          </button>
        ...
        <div id='ratings-div'>
          <div className='display-rating'>
            <svg xmlns="http://www.w3.org/2000/svg" width="27.5" height="27.5" viewBox="0 0 30 30" fill="none">
